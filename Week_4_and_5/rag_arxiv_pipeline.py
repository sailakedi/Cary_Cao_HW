...
Usage:
  python rag_arxiv_pipeline.py --out_dir data --n_papers 50
"""
...
# A helper to split on section boundaries first (optional nicer chunks)
...
def build_pipeline(out_dir: str, n_papers: int):
    ...
    # 3) prepping tokenizer for chunking
    #doc_text = "\n\n".join(p for p in text_pages if p)
